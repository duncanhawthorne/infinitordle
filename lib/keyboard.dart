...
Widget keyboardRowWidget(keyBoardStartKey, length, onKeyboardTapped) {
  return Container(
    ...
    child: GridView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return _kbStackWithMiniGrid(keyBoardStartKey + index, length, onKeyboardTapped);
        }),
  );
}

Widget _kbStackWithMiniGrid(index, length, onKeyboardTapped) {
  return Container(
